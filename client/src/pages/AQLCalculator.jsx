...
import AQLLogo from '@/components/AQLLogo.jsx'
...
export default function AQLCalculator() {
  ...
  // Auto-set inspection level when switching inspection type
  useEffect(() => {
    if (inspectionType === 'special') {
      setInspectionLevel('S2')
    } else {
      setInspectionLevel('II')
    }
  }, [inspectionType])
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="flex-shrink-0">
                <AQLLogo className="w-14 h-14 md:w-16 md:h-16" />
              </div>
            ...
            <div className="flex items-center gap-2 md:gap-3">
              <Button variant="outline" size="sm" onClick={() => setShowGuide(!showGuide)} className="text-xs md:text-sm">
        ...
        <div className="bg-blue-50 border-b border-blue-200">
          <div className="container mx-auto px-4 py-6">
            <div className="prose max-w-none">
              <h3 className="text-lg font-semibold text-blue-900 mb-3">{t("guideTitle")}</h3>
              <p className="text-sm text-blue-800 mb-4">
                {t("guideDescription")}
              </p>
              <h4 className="text-md font-semibold text-blue-900 mb-2">{t("howToUseTitle")}</h4>
