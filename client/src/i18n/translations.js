...
- ANSI/ASQ Z1.4-2003
    ...
    // 使用說明
    guideTitle: '什麼是 AQL？',
    guideDescription: 'AQL（Acceptable Quality Limit，最大可接受質量限值）是一種廣泛用於確定生產訂單樣品的方法，基於 ISO 2859-1 / ANSI Z1.4 國際標準，用於判斷整個產品訂單是否符合客戶的規格要求。',
    howToUseTitle: '如何使用：',
...
- ANSI/ASQ Z1.4-2003
    ...
    // Instructions
    guideTitle: 'What is AQL?',
    guideDescription: 'AQL (Acceptable Quality Limit) is a widely used method for determining production order samples, based on ISO 2859-1 / ANSI Z1.4 international standards, used to judge whether the entire product order meets customer specification requirements.',
