...
const samplingPlans = {
  2: { 
    ...
    '1.0': { ac: 0, re: 1 }, '1.5': { ac: 0, re: 1 }, '2.5': { ac: 0, re: 1 }, '4.0': '↓', '6.5': { ac: 0, re: 1 }
  },
  3: { 
    '0.065': '↑', '0.10': '↑', '0.15': '↑', '0.25': '↑', '0.40': '↑', '0.65': '↑', 
    '1.0': { ac: 0, re: 1 }, '1.5': { ac: 0, re: 1 }, '2.5': '↓', '4.0': { ac: 0, re: 1 }, '6.5': '↑'
  },
  5: { 
    '0.065': '↑', '0.10': '↑', '0.15': '↑', '0.25': '↑', '0.40': '↑', '0.65': '↑', 
    '1.0': '↓', '1.5': { ac: 0, re: 1 }, '2.5': { ac: 0, re: 1 }, '4.0': '↑', '6.5': { ac: 1, re: 2 }
  },
  8: { 
    '0.065': '↑', '0.10': '↑', '0.15': '↑', '0.25': '↑', '0.40': '↑', '0.65': '↓', 
    '1.0': { ac: 0, re: 1 }, '1.5': { ac: 0, re: 1 }, '2.5': '↑', '4.0': { ac: 1, re: 2 }, '6.5': '↓'
  },
  13: { 
    '0.065': '↑', '0.10': '↑', '0.15': '↑', '0.25': '↑', '0.40': '↓', 
    '0.65': { ac: 0, re: 1 }, '1.0': { ac: 0, re: 1 }, '1.5': '↑', '2.5': { ac: 1, re: 2 }, '4.0': '↓', '6.5': { ac: 2, re: 3 }
  },
  20: { 
    '0.065': '↑', '0.10': '↑', '0.15': '↑', '0.25': '↓', 
    '0.40': { ac: 0, re: 1 }, '0.65': { ac: 0, re: 1 }, '1.0': '↑', '1.5': { ac: 1, re: 2 }, '2.5': '↓', '4.0': { ac: 2, re: 3 }, '6.5': { ac: 3, re: 4 }
  },
  32: { 
    '0.065': '↑', '0.10': '↑', '0.15': '↓', 
    '0.25': { ac: 0, re: 1 }, '0.40': { ac: 0, re: 1 }, '0.65': '↑', '1.0': { ac: 1, re: 2 }, '1.5': '↓', '2.5': { ac: 2, re: 3 }, '4.0': { ac: 3, re: 4 }, '6.5': { ac: 5, re: 6 }
  },
  50: { 
    '0.065': '↑', '0.10': '↓', 
    '0.15': { ac: 0, re: 1 }, '0.25': { ac: 0, re: 1 }, '0.40': '↑', '0.65': { ac: 1, re: 2 }, '1.0': '↓', '1.5': { ac: 2, re: 3 }, '2.5': { ac: 3, re: 4 }, '4.0': { ac: 5, re: 6 }, '6.5': { ac: 7, re: 8 }
  },
  80: { 
    '0.065': '↓', 
    '0.10': { ac: 0, re: 1 }, '0.15': { ac: 0, re: 1 }, '0.25': '↑', '0.40': { ac: 1, re: 2 }, '0.65': '↓', '1.0': { ac: 2, re: 3 }, '1.5': '↑', '2.5': { ac: 5, re: 6 }, '4.0': { ac: 7, re: 8 }, '6.5': { ac: 10, re: 11 }
  },
  125: { 
    '0.065': { ac: 0, re: 1 }, '0.10': { ac: 0, re: 1 }, '0.15': '↑', 
    '0.25': { ac: 1, re: 2 }, '0.40': '↓', '0.65': { ac: 2, re: 3 }, '1.0': '↑', '1.5': { ac: 5, re: 6 }, '2.5': { ac: 7, re: 8 }, '4.0': { ac: 10, re: 11 }, '6.5': { ac: 14, re: 15 }
  },
  200: { 
    '0.065': { ac: 0, re: 1 }, '0.10': '↑', 
    '0.15': { ac: 1, re: 2 }, '0.25': '↓', '0.40': { ac: 2, re: 3 }, '0.65': '↑', '1.0': { ac: 5, re: 6 }, '1.5': '↓', '2.5': { ac: 10, re: 11 }, '4.0': { ac: 14, re: 15 }, '6.5': { ac: 21, re: 22 }
  },
  315: { 
    '0.065': '↑', 
    '0.10': { ac: 1, re: 2 }, '0.15': '↓', '0.25': { ac: 2, re: 3 }, '0.40': '↑', '0.65': { ac: 5, re: 6 }, '1.0': '↓', '1.5': { ac: 10, re: 11 }, '2.5': { ac: 14, re: 15 }, '4.0': { ac: 21, re: 22 }, '6.5': '↑'
  },
  500: { 
    '0.065': { ac: 0, re: 1 }, '0.10': '↓', 
    '0.15': { ac: 2, re: 3 }, '0.25': '↑', '0.40': { ac: 5, re: 6 }, '0.65': '↓', '1.0': { ac: 10, re: 11 }, '1.5': '↑', '2.5': { ac: 21, re: 22 }, '4.0': '↑', '6.5': '↑'
  },
  800: { 
    '0.065': { ac: 1, re: 2 }, '0.10': { ac: 1, re: 2 }, '0.15': '↑', 
    '0.25': { ac: 3, re: 4 }, '0.40': '↓', '0.65': { ac: 7, re: 8 }, '1.0': '↑', '1.5': { ac: 14, re: 15 }, '2.5': { ac: 21, re: 22 }, '4.0': '↑', '6.5': '↑'
  },
  1250: { 
    '0.065': { ac: 1, re: 2 }, '0.10': '↑', 
    '0.15': { ac: 3, re: 4 }, '0.25': '↓', '0.40': { ac: 7, re: 8 }, '0.65': '↑', '1.0': { ac: 14, re: 15 }, '1.5': '↓', '2.5': { ac: 21, re: 22 }, '4.0': '↑', '6.5': '↑'
  },
  2000: { 
    '0.065': '↑', 
    '0.10': { ac: 3, re: 4 }, '0.15': '↓', '0.25': { ac: 7, re: 8 }, '0.40': '↑', '0.65': { ac: 14, re: 15 }, '1.0': '↓', '1.5': { ac: 21, re: 22 }, '2.5': { ac: 21, re: 22 }, '4.0': '↑', '6.5': '↑'
  }
};
...
const aqlValuesInOrder = ['0.065', '0.10', '0.15', '0.25', '0.40', '0.65', '1.0', '1.5', '2.5', '4.0', '6.5'];
